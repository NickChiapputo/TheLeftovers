...
\begin{document}
	...
	\begin{thebibliography}{00}
		\bibitem{github} The Leftovers, \textit{GitHub}. [Online].Available: \url{https://github.com/NickChiapputo/TheLeftovers}
		\bibitem{website} The Leftovers, \textit{The Leftovers}. [Online].Available: \url{http://64.225.29.130/}
	\end{thebibliography}
